...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'analytics/deep', name: 'analytics-deep',
        component: () => import('@/views/AnalyticsDeep.vue'),
        meta: { title: '深度分析', skill: 'analytics', adminOnly: true } },
      ...
      { path: 'admin/scenarios', name: 'admin-scenarios',
        component: () => import('@/views/admin/ScenarioManage.vue'),
        meta: { title: '场景库管理', adminOnly: true } },
    ],
  },
